					...
					<div class="col-12">
					    ...
					    <div class="col-sm-10 pl-0">
					      <select class="custom-select custom-select-sm" id="type_of_loan" name="type_of_loan" required>
								  ...
								  <?php foreach ($loanTypes as $row): ?>
								  	<option value="<?php echo $row->loan_types_id; ?>"><?php echo $row->type; ?></option>
								  <?php endforeach; ?>
								</select>
					    </div>
					  </div>
					  ...
					  <div class="form-group row">
					    ...
					    <div class="col-sm-2 pl-0">
					      <input type="text" class="form-control form-control-sm font-12" id="loancomp_ref_no" name="loancomp_ref_no">
					    </div>
